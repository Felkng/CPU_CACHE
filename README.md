...
## Overview
This is a college work developed together with *[Luigi Eliabe](https://github.com/luigieli)*, *[João Kennedy Souza Soares](https://github.com/JoaoKSS)* and *[Rafael José](https://github.com/rafaeljosebraga)*, that aimed to develop a 16-bit data processor with a unified cache memory.
